...
When creating ANY component with text or backgrounds:
...
text-primary-foreground      // Button/primary text
...
ALL form components (Input, Textarea, Select, etc.) MUST include:
